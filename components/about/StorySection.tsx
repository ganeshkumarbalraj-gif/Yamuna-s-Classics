  ...
  return (
    <section className="max-w-6xl mx-auto px-6 py-16">
      ...
      <p className="mt-6 text-lg leading-9 text-gray-700">
        We create a wide range of handmade and customized products while
        conducting creative workshops that inspire people to learn,
        create and grow their artistic skills.
      </p>
